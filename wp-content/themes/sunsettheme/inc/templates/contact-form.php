<form id="sunsetContactForm" class="sunset-contact-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
  <div class="form-group">
    <input type="text" class="form-control sunset-form-control" name="name" id="name" placeholder="You Name"  />
    <small class="text-danger form-control-msg">Your Name is Required</small>
  </div>
  <div class="form-group">
    <input type="email" class="form-control sunset-form-control" name="email" id="email" placeholder="You Email"  />
  ...
  <div class="text-center">
    <button type="submit" class="btn btn-default bln-lg btn-sunset-form">Submit</button>
